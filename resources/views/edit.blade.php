...
<body class="bg-gray-100 min-h-screen py-8 px-4">
    <div class="max-w-4xl mx-auto">
        ...
        <header class="text-center mb-12">
            <h1 class="text-3xl font-bold text-black mb-2">Update</h1>
        ...
        <form action="/update/{{ $data->id }}" method="POST">
            ...
            <div class="mt-4 mb-8">
                <button type="submit"
                    class="bg-black hover:bg-gray-800 text-white font-medium py-3 px-8 w-full md:w-auto flex items-center justify-center gap-2 cursor-pointer">
                    Update Task
                </button>
            </div>
